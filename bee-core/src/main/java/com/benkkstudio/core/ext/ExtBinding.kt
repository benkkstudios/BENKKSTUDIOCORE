...
import com.benkkstudio.core.base.BaseDialog
import com.benkkstudio.core.base.BaseFragment
...
internal fun <V : ViewBinding> BaseDialog<V>.getBinding(): V {
    return findClass().getBinding(layoutInflater)
}

@Suppress("UNCHECKED_CAST")
internal fun <T : ViewModel> getTClass(context: Context): Class<T> {
    return (context.javaClass.genericSuperclass as ParameterizedType).actualTypeArguments[0] as Class<T>
}